...
class SeeMore2 extends StatefulWidget {
  const SeeMore2({Key? key}) : super(key: key);

  @override
  _SeeMore2State createState() => _SeeMore2State();
}
...
class _SeeMore2State extends State<SeeMore2> {
  ...
  Widget build(BuildContext context) {
    ...
    Project2? project = ModalRoute.of(context)!.settings.arguments as Project2?;
    return Scaffold(
                  ...
                  Center(
                    child: Row(
                      ...
                      children: [
                        SizedBox(width: MediaQuery.of(context).size.width /10,),
                        SizedBox(
                          width: MediaQuery.of(context).size.width/5,height:  MediaQuery.of(context).size.height/2,
